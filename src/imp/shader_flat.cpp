...
void Shader_flat::Update(Camera *camera, Light *light, object::SingleBodyObject* obj) {
...
void Shader_flat::UpdateForReflection(Camera *camera, Light *light, object::SingleBodyObject *obj, object::CheckerBoard *chk) {
